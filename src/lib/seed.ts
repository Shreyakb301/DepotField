...
const orders: Order[] = [
  { id: "o1", orderNumber: "ORD-4001", customer: "Customer #18109", items: [{ productId: "p1", qty: 3 }], status: "Shipped", priority: "Low", createdAt: "2026-08-30", updatedAt: "2026-09-02" },
  { id: "o2", orderNumber: "ORD-4002", customer: "Customer #14064", items: [{ productId: "p2", qty: 6 }], status: "Shipped", priority: "Low", createdAt: "2026-08-30", updatedAt: "2026-09-02" },
  { id: "o3", orderNumber: "ORD-4003", customer: "Customer #16496", items: [{ productId: "p3", qty: 6 }], status: "Shipped", priority: "Medium", createdAt: "2026-08-31", updatedAt: "2026-09-03" },
  { id: "o4", orderNumber: "ORD-4004", customer: "Customer #14247", items: [{ productId: "p4", qty: 1 }], status: "Shipped", priority: "Low", createdAt: "2026-09-01", updatedAt: "2026-09-04" },
  { id: "o5", orderNumber: "ORD-4005", customer: "Customer #16923", items: [{ productId: "p5", qty: 3 }], status: "Shipped", priority: "Medium", createdAt: "2026-09-02", updatedAt: "2026-09-05" },
  { id: "o6", orderNumber: "ORD-4006", customer: "Customer #14862", items: [{ productId: "p6", qty: 6 }], status: "Packed", priority: "Medium", createdAt: "2026-09-05", updatedAt: "2026-09-09" },
  { id: "o7", orderNumber: "ORD-4007", customer: "Customer #14903", items: [{ productId: "p7", qty: 3 }], status: "Packed", priority: "Low", createdAt: "2026-09-06", updatedAt: "2026-09-10" },
  { id: "o8", orderNumber: "ORD-4008", customer: "Customer #14587", items: [{ productId: "p8", qty: 1 }], status: "Packed", priority: "Low", createdAt: "2026-09-06", updatedAt: "2026-09-10" },
  { id: "o9", orderNumber: "ORD-4009", customer: "Customer #16686", items: [{ productId: "p9", qty: 2 }], status: "Packed", priority: "Medium", createdAt: "2026-09-07", updatedAt: "2026-09-11" },
  { id: "o10", orderNumber: "ORD-4010", customer: "Customer #13614", items: [{ productId: "p10", qty: 1 }], status: "Packed", priority: "High", createdAt: "2026-09-08", updatedAt: "2026-09-11" },
  { id: "o11", orderNumber: "ORD-4011", customer: "Customer #16369", items: [{ productId: "p11", qty: 4 }], status: "Picking", priority: "Medium", createdAt: "2026-09-09", updatedAt: "2026-09-12" },
  { id: "o12", orderNumber: "ORD-4012", customer: "Customer #15068", items: [{ productId: "p12", qty: 3 }], status: "Picking", priority: "Low", createdAt: "2026-09-10", updatedAt: "2026-09-12" },
  { id: "o13", orderNumber: "ORD-4013", customer: "Customer #15640", items: [{ productId: "p13", qty: 6 }], status: "Picking", priority: "Medium", createdAt: "2026-09-10", updatedAt: "2026-09-13" },
  { id: "o14", orderNumber: "ORD-4014", customer: "Customer #17894", items: [{ productId: "p14", qty: 2 }], status: "Picking", priority: "High", createdAt: "2026-09-11", updatedAt: "2026-09-13" },
  { id: "o15", orderNumber: "ORD-4015", customer: "Customer #17338", items: [{ productId: "p15", qty: 2 }], status: "Picking", priority: "Low", createdAt: "2026-09-11", updatedAt: "2026-09-13" },
  { id: "o16", orderNumber: "ORD-4016", customer: "Customer #14001", items: [{ productId: "p13", qty: 6 }, { productId: "p10", qty: 12 }], status: "New", priority: "Medium", createdAt: "2026-09-12", updatedAt: "2026-09-12" },
  { id: "o17", orderNumber: "ORD-4017", customer: "Customer #14056", items: [{ productId: "p15", qty: 1 }, { productId: "p8", qty: 2 }], status: "New", priority: "Low", createdAt: "2026-09-13", updatedAt: "2026-09-13" },
  { id: "o18", orderNumber: "ORD-4018", customer: "Customer #14214", items: [{ productId: "p4", qty: 2 }, { productId: "p12", qty: 12 }, { productId: "p5", qty: 3 }], status: "New", priority: "High", createdAt: "2026-09-13", updatedAt: "2026-09-13" },
  { id: "o19", orderNumber: "ORD-4019", customer: "Customer #12886", items: [{ productId: "p11", qty: 12 }, { productId: "p4", qty: 2 }], status: "New", priority: "Medium", createdAt: "2026-09-14", updatedAt: "2026-09-14" },
  { id: "o20", orderNumber: "ORD-4020", customer: "Customer #18158", items: [{ productId: "p8", qty: 10 }, { productId: "p7", qty: 10 }], status: "New", priority: "Low", createdAt: "2026-09-14", updatedAt: "2026-09-14" },
];
